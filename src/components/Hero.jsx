  ...
  return (
    <section ref={containerRef} className="relative min-h-[100vh] flex flex-col items-center justify-center pt-32 pb-20 overflow-hidden">
      ...
      >
        ...
        >
          <a href="/Trace.apk" download className="group relative px-8 py-4 bg-jade-500 text-bg-card font-bold rounded-xl overflow-hidden box-glow hover:scale-105 active:scale-95 transition-all duration-300">
            <span className="relative z-10 flex items-center gap-2">
              Download App
            </span>
          </a>
          <a href=" https://trace-app-xi.vercel.app" target="_blank" rel="noreferrer" className="px-8 py-4 bg-bg-card border border-border text-fg font-bold rounded-xl hover:border-jade-500/50 hover:text-jade-400 hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-2">
            Try Web Version
          </a>
        </motion.div>
      </motion.div>
